      ...
      <div className="flex items-center justify-between mt-8 w-full max-w-4xl flex-col sm:flex-row gap-4">
        ...
        <div className="bg-white w-full sm:w-[450px] rounded-md shadow-lg p-4">
          ...
          <div className="flex flex-wrap gap-x-2 mt-6">
            ...
            {/* Vertical Border */}
            <div className="hidden sm:block border-l-2 border-gray-300 h-[48px] mx-2"></div>
            ...
            <div className="flex flex-col justify-between w-full sm:w-auto">
              <ul>
                ...
                <div className="flex items-center gap-x-2">
                  <li className="text-xs truncate">Select your date</li>
            ...
            <div className="flex flex-col justify-between w-full sm:w-auto">
              <ul>
                ...
                <div className="flex items-center gap-x-2">
                  <li className="text-xs truncate">Select your time</li>
                  <Image src="/images/arrow.png" alt="" height={6} width={18} />
                </div>
              </ul>
            </div>
